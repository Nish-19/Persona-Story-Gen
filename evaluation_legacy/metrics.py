    ...
    def diversity_scores(self, config, verbose=False):
        ...
        def get_homogenization_score(homo_type, verbose=False):
            ...
            with suppress_output():
                homogenization_score_gt = homogenization_score(gt, homo_type, verbose=verbose) if self.compute_gt else 'None'
                homogenization_score_gen = homogenization_score(gen, homo_type, verbose=verbose)
