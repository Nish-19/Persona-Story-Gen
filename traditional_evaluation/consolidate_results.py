...
def main():
    ...
    consolidate_vanilla, consolidate_gt = get_consolidated_results(
        vanilla_dir, store_gt=True
    )
    ...
    for source_dir in source_dirs:
        if source_dir == "vanilla":
            ...
            if os.path.isdir(source_dir_path):
                consolidate_results, _ = get_consolidated_results(
                    source_dir_path, store_gt=False
                )
