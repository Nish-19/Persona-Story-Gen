...
def main():
    ...
    for file in tqdm(os.listdir(data_dir), desc='Generating Writing Prompts', total=len(os.listdir(data_dir))):
            ...
            with open(file_path, 'r') as f:
                ...
                for i, story in enumerate(data):
                    if data_choice != 'Reddit':
                        ...
                        prompt_message = construct_prompt_message(system_prompt, f"Story: {story['comment']}\n\nPrompt:", few_shot_prompts)
                        # prompt openai
                        ...
                        story['writing_prompt'] = story['post_title'].split('[WP]')[1].strip()
    
                    # save the data after every story
                    with open(f'../datasets/{data_choice}/selected_human_with_prompts/{file}', 'w') as f:
